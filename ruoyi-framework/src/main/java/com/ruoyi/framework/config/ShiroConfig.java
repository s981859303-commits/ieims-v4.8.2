...
public class ShiroConfig
{
    ...
    // ===================== 新增：读取application.yml中的匿名放行路径 =====================
    @Value("${shiro.anon-paths}")
    private String[] anonPaths; // 接收yml中的数组配置，存为字符串数组
    // ==================================================================================
    /**
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/ieims.png**", "anon");
        ...
        // ===================== 改造：动态遍历配置文件中的放行路径（核心修改） =====================
        // 遍历anonPaths数组，批量添加放行规则（替代硬编码）
        for (String path : anonPaths) {
//            System.out.println(path);
            filterChainDefinitionMap.put(path, "anon"); // anon = 匿名访问，无需登录
        }
        // ==================================================================================
